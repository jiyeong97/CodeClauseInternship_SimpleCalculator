...
import kotlinx.android.synthetic.main.activity_summer.*
...
class SummerActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setTheme(R.style.SummerSplashTheme)
        Thread.sleep(1500)
        setContentView(R.layout.activity_summer)
    }

    fun openWarm(view: View){
        val intent = Intent(this, WarmActivity::class.java)
        finish();
